...
function Comp(p: Props): React.JSX.Element {
  return <>
    <PriceInputSection label={p.t("listings.price")} fromValue={p.floorSalePriceFrom} toValue={p.floorSalePriceTo} onFromChange={p.onPriceFromChange} onToChange={p.onPriceToChange} />
    ...
    <PriceInputSection label={p.t("listings.areaM2")} fromValue={p.floorSaleAreaFrom} toValue={p.floorSaleAreaTo} onFromChange={p.onAreaFromChange} onToChange={p.onAreaToChange} fromPlaceholder={p.t("listings.fromArea")} toPlaceholder={p.t("listings.toArea")} />
    ...
    <ToggleGroup toggles={[
      { label: p.t("listings.carEntrance"), value: p.floorSaleCarEntrance, onValueChange: p.onCarEntranceChange },
