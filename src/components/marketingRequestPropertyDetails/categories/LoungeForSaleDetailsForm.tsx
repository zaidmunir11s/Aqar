...
export default function LoungeForSaleDetailsForm({
  ...
  return (
    <>
      ...
      <ToggleRow label={t("listings.pool")} value={toggles.pool} onValueChange={(v)=>setToggles(p=>({...p, pool:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      <ToggleRow label={t("listings.footballPitch")} value={toggles.footballPitch} onValueChange={(v)=>setToggles(p=>({...p, footballPitch:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      <ToggleRow label={t("listings.volleyballCourt")} value={toggles.volleyballCourt} onValueChange={(v)=>setToggles(p=>({...p, volleyballCourt:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      ...
      <ToggleRow label={t("listings.playground")} value={toggles.playground} onValueChange={(v)=>setToggles(p=>({...p, playground:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      <ToggleRow label={t("listings.familySection")} value={toggles.familySection} onValueChange={(v)=>setToggles(p=>({...p, familySection:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
