...
interface Props {
  ...
  onFootballPitchChange: (v: boolean) => void;
  onVolleyballCourtChange: (v: boolean) => void;
  onTentChange: (v: boolean) => void;
  onKitchenChange: (v: boolean) => void;
  onPlaygroundChange: (v: boolean) => void;
    ...
    <>
      ...
      <ToggleGroup
        toggles={[
          ...
          {
            label: p.t("listings.footballPitch"),
            value: p.footballPitch,
            onValueChange: p.onFootballPitchChange,
          },
          {
            label: p.t("listings.volleyballCourt"),
            value: p.volleyballCourt,
            onValueChange: p.onVolleyballCourtChange,
          },
          {
          ...
          {
            label: p.t("listings.playground"),
            value: p.playground,
            onValueChange: p.onPlaygroundChange,
          },
          {
