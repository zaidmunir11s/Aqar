...
export default function FarmForSaleDetailsForm({ onFormDataChange }: CategoryFormProps): React.JSX.Element {
  ...
  }, [onFormDataChange, streetWidth, t, tent, toggles.drainageAvailability, toggles.electricity, toggles.water, trees, well]);
  ...
  return (
    <>
      ...
      <SliderWithInput label={t("listings.well")} value={well} onChangeValue={setWell} max={10} />
      <SliderWithInput label={t("listings.trees")} value={trees} onChangeValue={setTrees} max={10} />
