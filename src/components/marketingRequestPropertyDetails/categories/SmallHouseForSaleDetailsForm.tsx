...
export default function SmallHouseForSaleDetailsForm({
  ...
  return (
    <>
      ...
      <ToggleRow label={t("listings.driverRoom")} value={toggles.driverRoom} onValueChange={(v)=>setToggles(p=>({...p, driverRoom:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      <ToggleRow label={t("listings.maidRoom")} value={toggles.maidRoom} onValueChange={(v)=>setToggles(p=>({...p, maidRoom:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      <ToggleRow label={t("listings.furnished")} value={toggles.furnished} onValueChange={(v)=>setToggles(p=>({...p, furnished:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      <ToggleRow label={t("listings.tent")} value={toggles.tent} onValueChange={(v)=>setToggles(p=>({...p, tent:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      <ToggleRow label={t("listings.backyard")} value={toggles.backyard} onValueChange={(v)=>setToggles(p=>({...p, backyard:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      <ToggleRow label={t("listings.kitchen")} value={toggles.kitchen} onValueChange={(v)=>setToggles(p=>({...p, kitchen:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      <ToggleRow label={t("listings.extraUnit")} value={toggles.extraUnit} onValueChange={(v)=>setToggles(p=>({...p, extraUnit:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      <ToggleRow label={t("listings.carEntrance")} value={toggles.carEntrance} onValueChange={(v)=>setToggles(p=>({...p, carEntrance:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      <ToggleRow label={t("listings.water")} value={toggles.water} onValueChange={(v)=>setToggles(p=>({...p, water:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      <ToggleRow label={t("listings.electricity")} value={toggles.electricity} onValueChange={(v)=>setToggles(p=>({...p, electricity:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
      <ToggleRow label={t("listings.drainageAvailability")} value={toggles.drainageAvailability} onValueChange={(v)=>setToggles(p=>({...p, drainageAvailability:v}))} trackWidth={TOGGLE_TRACK_WIDTH} trackHeight={TOGGLE_TRACK_HEIGHT} thumbSize={TOGGLE_THUMB_SIZE} />
    </>
  );
}
