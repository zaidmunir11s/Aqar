...
export default function BigFlatForRentDetailsForm({
  ...
  React.useEffect(() => {
    if (!floorValue && floorOptions.length) setFloorValue(floorOptions[0]);
  ...
  return (
    <>
      ...
      {["furnished","carEntrance","airConditioned","water","electricity","apartmentInVilla","twoEntrances","specialEntrance","drainageAvailability"].map((k) => (
