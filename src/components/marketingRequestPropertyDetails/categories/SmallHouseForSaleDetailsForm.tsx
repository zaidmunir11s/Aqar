...
export default function SmallHouseForSaleDetailsForm({
  ...
  return (
    <>
      ...
      <ToggleRow
        label={t("listings.driverRoom")}
        value={toggles.driverRoom}
        onValueChange={(v) => setToggles((p) => ({ ...p, driverRoom: v }))}
      ...
      <ToggleRow
        label={t("listings.maidRoom")}
        value={toggles.maidRoom}
        onValueChange={(v) => setToggles((p) => ({ ...p, maidRoom: v }))}
        trackWidth={TOGGLE_TRACK_WIDTH}
        trackHeight={TOGGLE_TRACK_HEIGHT}
        thumbSize={TOGGLE_THUMB_SIZE}
      />
      <ToggleRow
        ...
        onValueChange={(v) => setToggles((p) => ({ ...p, furnished: v }))}
        trackWidth={TOGGLE_TRACK_WIDTH}
        trackHeight={TOGGLE_TRACK_HEIGHT}
        thumbSize={TOGGLE_THUMB_SIZE}
      />
      ...
      <ToggleRow
        label={t("listings.backyard")}
        value={toggles.backyard}
        onValueChange={(v) => setToggles((p) => ({ ...p, backyard: v }))}
        trackWidth={TOGGLE_TRACK_WIDTH}
        trackHeight={TOGGLE_TRACK_HEIGHT}
        thumbSize={TOGGLE_THUMB_SIZE}
      />
      <ToggleRow
        ...
        onValueChange={(v) => setToggles((p) => ({ ...p, kitchen: v }))}
        trackWidth={TOGGLE_TRACK_WIDTH}
        trackHeight={TOGGLE_TRACK_HEIGHT}
        thumbSize={TOGGLE_THUMB_SIZE}
      />
      <ToggleRow
        ...
        onValueChange={(v) => setToggles((p) => ({ ...p, extraUnit: v }))}
        trackWidth={TOGGLE_TRACK_WIDTH}
        trackHeight={TOGGLE_TRACK_HEIGHT}
        thumbSize={TOGGLE_THUMB_SIZE}
      />
