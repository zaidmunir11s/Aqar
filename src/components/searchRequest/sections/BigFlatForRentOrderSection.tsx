...
interface Props {
  ...
  onBedroomSelect: (v: string) => void; onLivingRoomSelect: (v: string) => void; onWcSelect: (v: string) => void;
  onOpenFloor: () => void; onOpenAge: () => void;
  ...
  onCarEntranceChange: (v: boolean) => void; onAirConditionedChange: (v: boolean) => void; onApartmentInVillaChange: (v: boolean) => void; onTwoEntrancesChange: (v: boolean) => void; onSpecialEntrancesChange: (v: boolean) => void; onNearBusChange: (v: boolean) => void; onNearMetroChange: (v: boolean) => void;
}
...
function Comp(p: Props): React.JSX.Element {
  return <>
    ...
    <ToggleGroup toggles={[
      ...
      { label: p.t("listings.airConditioned"), value: p.airConditioned, onValueChange: p.onAirConditionedChange },
