          ...
          tabPress: (e) => {
            ...
            if (!isOnPropertyList) {
              ...
              if (parent) {
                ...
                const dailyIndex = tabState.routes.findIndex(
                  (r) => r.name === "Daily"
                );
                ...
                if (dailyIndex !== -1) {
                  ...
                  const filterFromCurrentRoute =
                    currentRouteParams?.selectedFilter;
                  ...
                  const propertyListRouteInStack =
                    currentDailyState?.routes?.find(
                      (r: any) => r.name === "PropertyList"
                    );
                  const filterFromStack =
                    propertyListRouteInStack?.params?.selectedFilter;
              ...
              if (
                preservedFilter &&
                currentRoute?.params?.selectedFilter !== preservedFilter
              ) {
                e.preventDefault();
                navigation.navigate("Daily", {
                  screen: "PropertyList",
